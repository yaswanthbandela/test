...
#sudo mv -r /var/www/html_backup/* /var/www/html/
...
sudo cp /var/www/html_backup/wp-config-live.php /var/www/html/wp-config.php  # Assuming this is your live configuration file
