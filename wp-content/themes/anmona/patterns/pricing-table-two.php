 ...
 * @package Anmona
 */
    $anmona_pricing_table_two = [
        'check' => ANMONA_THEME_URI . '/assets/images/check.png',
    ];
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|anmona-extra-large","bottom":"var:preset|spacing|anmona-extra-large","left":"var:preset|spacing|anmona-medium","right":"var:preset|spacing|anmona-medium"},"margin":{"top":"0","bottom":"0"},"blockGap":"var:preset|spacing|20"},"dimensions":{"minHeight":"40vh"}},"backgroundColor":"anmona-navy-blue","className":"has-background-color","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull has-background-color has-anmona-navy-blue-background-color has-background" style="min-height:40vh;margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--anmona-extra-large);padding-right:var(--wp--preset--spacing--anmona-medium);padding-bottom:var(--wp--preset--spacing--anmona-extra-large);padding-left:var(--wp--preset--spacing--anmona-medium)"><!-- wp:heading {"textAlign":"center","level":3,"style":{"spacing":{"margin":{"top":"0","bottom":"var:preset|spacing|anmona-extra-small"}},"elements":{"link":{"color":{"text":"var:preset|color|anmona-white"}}}},"textColor":"anmona-white"} -->
<h3 class="wp-block-heading has-text-align-center has-anmona-white-color has-text-color has-link-color" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--anmona-extra-small)"><?php echo esc_html__( 'Pricing', 'anmona' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","style":{"elements":{"link":{"color":{"text":"var:preset|color|anmona-white"}}}},"textColor":"anmona-white"} -->
<p class="has-text-align-center has-anmona-white-color has-text-color has-link-color"><?php echo esc_html__( 'Choose best pricing that suites your requirement.', 'anmona' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-column is-vertically-aligned-bottom"><!-- wp:group {"style":{"border":{"radius":"15px","width":"1px"},"spacing":{"padding":{"right":"var:preset|spacing|anmona-medium","left":"var:preset|spacing|anmona-medium","top":"var:preset|spacing|anmona-medium","bottom":"var:preset|spacing|anmona-medium"}}},"borderColor":"anmona-closet-gray","backgroundColor":"anmona-closet-white","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-border-color has-anmona-closet-gray-border-color has-anmona-closet-white-background-color has-background" style="border-width:1px;border-radius:15px;padding-top:var(--wp--preset--spacing--anmona-medium);padding-right:var(--wp--preset--spacing--anmona-medium);padding-bottom:var(--wp--preset--spacing--anmona-medium);padding-left:var(--wp--preset--spacing--anmona-medium)"><!-- wp:heading {"level":5} -->
...
<figure class="wp-block-image size-large is-resized"><img src="<?php echo esc_url( $anmona_pricing_table_two[ 'check' ] );?>" alt="check box" style="object-fit:cover;width:24px;height:24px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<figure class="wp-block-image size-large is-resized"><img src="<?php echo esc_url( $anmona_pricing_table_two[ 'check' ] );?>" alt="check box" style="width:24px;height:undefinedpx"/></figure>
<!-- /wp:image -->
...
<div class="wp-block-column is-vertically-aligned-bottom"><!-- wp:group {"style":{"border":{"radius":"15px","width":"1px"},"spacing":{"padding":{"top":"var:preset|spacing|anmona-medium","bottom":"var:preset|spacing|anmona-medium","left":"var:preset|spacing|anmona-medium","right":"var:preset|spacing|anmona-medium"}}},"borderColor":"black","backgroundColor":"anmona-white","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-border-color has-black-border-color has-anmona-white-background-color has-background" style="border-width:1px;border-radius:15px;padding-top:var(--wp--preset--spacing--anmona-medium);padding-right:var(--wp--preset--spacing--anmona-medium);padding-bottom:var(--wp--preset--spacing--anmona-medium);padding-left:var(--wp--preset--spacing--anmona-medium)"><!-- wp:heading {"level":5} -->
...
<div class="wp-block-group"><!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"top"}} -->
<div class="wp-block-group"><!-- wp:group {"layout":{"type":"constrained","contentSize":"25px"}} -->
<div class="wp-block-group"><!-- wp:image {"lightbox":{"enabled":false},"id":155,"width":"24px","height":"auto","scale":"cover","sizeSlug":"full","linkDestination":"none","style":{"color":{"duotone":"var:preset|duotone|dark-grayscale"}},"className":"is-resized"} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( $anmona_pricing_table_two[ 'check' ] );?>" alt="" class="wp-image-155" style="object-fit:cover;width:24px;height:auto"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"top"}} -->
<div class="wp-block-group"><!-- wp:image {"width":"24px","height":"undefinedpx","sizeSlug":"large","linkDestination":"none","style":{"color":{"duotone":"var:preset|duotone|dark-grayscale"}},"className":"is-resized"} -->
<figure class="wp-block-image size-large is-resized"><img src="<?php echo esc_url( $anmona_pricing_table_two[ 'check' ] );?>" alt="check box" style="width:24px;height:undefinedpx"/></figure>
<!-- /wp:image -->
