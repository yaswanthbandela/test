...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--anmona-huge);padding-bottom:var(--wp--preset--spacing--anmona-huge)"><!-- wp:columns {"verticalAlignment":"center","style":{"spacing":{"blockGap":{"left":"var:preset|spacing|anmona-normal"}}}} -->
...
<p class="has-small-font-size"><?php echo esc_html__( 'Anmona is not just another WordPress theme; it\'s a revolution in web design. Built upon the innovative concept of full site editing, Anmona empowers users to craft stunning websites with unparalleled ease and flexibility.', 'anmona' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:40%"><!-- wp:image {"align":"center","lightbox":{"enabled":true},"id":42,"width":"400px","aspectRatio":"1","scale":"cover","sizeSlug":"full","linkDestination":"none","style":{"border":{"radius":"5%","width":"2px","color":"#FFFFFF"}},"className":"is-style-default"} -->
<figure class="wp-block-image aligncenter size-full is-resized has-custom-border is-style-default"><img src="<?php echo esc_url( $anmona_transparent_header['admin_img'] );?>" alt="" class="has-border-color wp-image-42" style="border-color:#FFFFFF;border-width:2px;border-radius:5%;aspect-ratio:1;object-fit:cover;width:400px"/></figure>
<!-- /wp:image -->

<!-- wp:social-links {"iconColor":"anmona-black","iconColorValue":"#232323","iconBackgroundColor":"anmona-closet-gray","iconBackgroundColorValue":"#eeeeee","className":"is-style-default","layout":{"type":"flex","justifyContent":"center"}} -->
<ul class="wp-block-social-links has-icon-color has-icon-background-color is-style-default"><!-- wp:social-link {"url":"https://profiles.wordpress.org/binsaifullah/","service":"wordpress"} /-->

<!-- wp:social-link {"url":"https://github.com/zakariabinsaifullah","service":"github"} /-->

<!-- wp:social-link {"url":"https://www.youtube.com/channel/UC-1BnLWTKLkHdF2aFgd5Hug","service":"youtube"} /--></ul>
<!-- /wp:social-links --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div></div>
